 ...
 * @author Daniel
 */
public class FRMDevolucaoProduto extends javax.swing.JFrame {
    ...
    private ArrayList<ProdutosGravados> produtos = new ArrayList<ProdutosGravados>();
    ...
    public FRMDevolucaoProduto() {
        ...
        System.out.println("devolucao " + venda);
    ...
    private void buscar() {
        ...
        call.enqueue(new Callback<ArrayList<ProdutosGravados>>() {
            ...
            @Override
            public void onFailure(Call<ArrayList<ProdutosGravados>> call, Throwable thrwbl) {
                SwingUtilities.invokeLater(new Runnable() {
                    public void run() {
                        a.setVisible(false);
                    }
    ...
    public void setCombo(ArrayList<ProdutosGravados> pp) {
        DefaultComboBoxModel modelo = new DefaultComboBoxModel();
        if (pp.size() > 0) {
            for (ProdutosGravados p : pp) {
                modelo.addElement(p.getCodProduto() + " : " + p.getNome() + " : R$ " + p.getValorUNI());
            }
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Quantidade da Compra:");
        ...
        jtfMotivo.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        jPanel4Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jtfMotivo, javax.swing.GroupLayout.PREFERRED_SIZE, 436, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(jtfQtd, javax.swing.GroupLayout.DEFAULT_SIZE, 43, Short.MAX_VALUE)
        ...
        jLabel40.setText("DEVOLUÇÃO DE PRODUTO");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGap(57, 57, 57))
            .addComponent(jPanel12, javax.swing.GroupLayout.PREFERRED_SIZE, 702, Short.MAX_VALUE)
        );
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        SharedPreferencesEmpresaBEAN sh = SharedPEmpresa_Control.listar();
        LojaAPI api = SyncDefault.RETROFIT_LOJA.create(LojaAPI.class);
        final Call<Void> call = api.devolverPedido(new Gson().toJson(dados), this.pedido + "", sh.getEmpEmail(), sh.getEmpSenha());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FRMDevolucaoProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRMDevolucaoProduto().setVisible(true);
    ...
    public void setProdutos(ProdutosGravados pro) {
        lbCodigo.setText(pro.getCodProduto() + "");
        lbNome.setText(pro.getNome());
        lbPreco.setText(pro.getValorUNI() + "");
        lbQtd.setText(pro.getQuantidade() + "");
        pedido = pro.getCodPedidVenda();
        comboProduto.getEditor().setItem(pro.getCodProduto() + " : " + pro.getNome() + " : R$ " + pro.getValorUNI());
    }
    ...
    private DevolucaoBEAN getDados() {
        DevolucaoBEAN d = new DevolucaoBEAN();
        d.setProduto(lbCodigo.getText());
        d.setQuantidade(Float.parseFloat(jtfQtd.getText()));
        d.setMotivo(jtfMotivo.getText());
        d.setValor(Float.parseFloat(lbPreco.getText()) * Float.parseFloat(jtfQtd.getText()));
