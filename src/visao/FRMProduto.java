...
public class FRMProduto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        comboTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--Selecione o Tipo--", "Serviço", "Produto" }));
        ...
        jPanel9Layout.setVerticalGroup(
            ...
            .addGroup(jPanel9Layout.createSequentialGroup()
                ...
                .addComponent(jtfGarantia, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addComponent(jLabel44)
                .addGap(18, 18, 18)
    ...
    private String verificaCampos() {
        ...
        if (comboTipo.getSelectedItem().equals("Produto")) {
...
//Depois formata data
            dTable.addRow(new Object[]{dado.getCodigo(), dado.getNome(),
                ...
                dado.getGarantia() + " dias", dado.getTipo()
            });
        }
